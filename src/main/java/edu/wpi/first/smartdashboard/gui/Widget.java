...
public abstract class Widget extends DisplayElement {
  ...
  public static class NumberSlider extends JSlider implements NumberBindable, ComponentListener,
      ChangeListener {
  ...
  public static class NumberProgressBar extends JProgressBar implements NumberBindable,
      ComponentListener {
